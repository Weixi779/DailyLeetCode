...
public struct LT0380InsertDeleteGetrandomO1: LeetCodeTask {
    public let id = "0380"
    public let title = "O(1) 时间插入、删除和获取随机元素"
    public let url = URL(string: "https://leetcode.cn/problems/insert-delete-getrandom-o1/")!
    ...
    class RandomizedSet {
        ...
        func remove(_ val: Int) -> Bool {
            guard let valIndex = map[val] else { return false }
